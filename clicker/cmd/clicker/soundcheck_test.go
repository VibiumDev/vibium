...
func TestSoundcheckReportsAllConfigurationProblemsWithoutProbing(t *testing.T) {
	...
	for _, name := range []string{"VIBIUM_VERIFIER_MODEL", "OPENAI_API_KEY", "VIBIUM_VERIFIER_BASE_URL", "VIBIUM_VERIFIER_REASONING_EFFORT"} {
		if !failed[name] {
...
func TestSoundcheckProviderOutcomeAndFixes(t *testing.T) {

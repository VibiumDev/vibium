...
func addModelFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String("ai-base-url", "", "Override the AI provider's API base URL for this call (the model endpoint, not the site under test); an empty value resets the provider default")

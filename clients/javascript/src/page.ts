...
export class Page {
  ...
  /**
   * @internal Resolve when this page's WebSocket monitor is installed, rejecting
   * if the install failed. The sync wrapper awaits it so its blocking
   * `onWebSocket()` reports a failure the async caller has no way to see.
   */
